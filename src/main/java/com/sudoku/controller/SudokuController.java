    ...
    private void initController() {
        ...
        view.getBtnGenerate().addActionListener(e -> {
            ...
            new SwingWorker<Void, Void>() {
                @Override protected Void doInBackground() { engine.solve(currentMatrix); return null; }
                @Override protected void done() { view.updateStatus("Ván chơi đã sẵn sàng!"); }
            }.execute();
...
//Refresh lại lỗi sau khi click ô
    ...
    private void triggerGameOver(boolean won) {
        ...
        if (won) {
            ...
            view.getBtnGenerate().doClick(); // Tự tạo ván mới
        }
    }
}